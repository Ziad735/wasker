...
document.addEventListener("DOMContentLoaded", function () {
    ...
    document.querySelectorAll('a').forEach(link => {
        link.addEventListener('click', function (event) {
            ...
            fetch(url)
                ...
                .catch(error => console.error('ÐŸÐ¾Ð¼Ð¸Ð»ÐºÐ° Ð¿Ñ€Ð¸ Ð·Ð°Ð²Ð°Ð½Ñ‚Ð°Ð¶ÐµÐ½Ð½Ñ– ÑÑ‚Ð¾Ñ€Ñ–Ð½ÐºÐ¸:', error));
        });
    });
    ...
    const strings = ["Ui/ux Designer", "Web Developer", "Graphic Designer", "Dreamer ðŸ˜Š"];
    const typeSpeed = 70;
    const backSpeed = 20;
